...
class Network(object):
    ...
    def draw(self, node_list, color_map, shape_map):
        nx.draw(self.graph, nodelist=node_list, node_color=color_map, shape_map=shape_map, with_labels=True, font_size=6)
        plt.show()
